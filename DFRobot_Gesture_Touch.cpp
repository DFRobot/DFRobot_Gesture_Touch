/*!
 * @file DFRobot_Gesture_Touch.cpp
 * @brief This is a sensor library for gesture and touch detection.
...
DFRobot_Gesture_Touch::DFRobot_Gesture_Touch(DFGT_Serial *pSerial)
{
  _pSerial = pSerial;
  _pSerial->begin(9600);
